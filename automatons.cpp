...
void Automatons::StartAutomatons(Token::TokenSubtype &keyoptype){
    datatype = &keyoptype;
    charcounter = 0;
...
Token::TokenType Automatons::GetToken(QString word, Token::TokenSubtype &keyoptype){
...
bool Automatons::Automaton_Reserved_bolichisky(QChar c){
    ...
    case 9:
        ...
        if(c == 'y'){
            ...
            *datatype = Token::TokenSubtype::bolichisky;
            return true;
        }
        break;
    default:
...
bool Automatons::Automaton_Reserved_ch_arovsky(QChar c){
    ...
    case 8:
        ...
        if(c == 'y'){
            token = Token::TokenType::keyword;
            *datatype = Token::TokenSubtype::charovsky;
            return true;
        }
        break;
    default:
...
bool Automatons::Automaton_Reserved_ch_ernobyl(QChar c){
    ...
    case 8:
        ...
        if(c == 'l'){
            token = Token::TokenType::keyword;
            *datatype = Token::TokenSubtype::chernobyl;
            return true;
        }
        break;
    default:
...
bool Automatons::Automaton_Reserved_f_orevisky(QChar c){
    ...
    case 8:
        ...
        if(c == 'y'){
            token = Token::TokenType::keyword;
            *datatype = Token::TokenSubtype::forevisky;
            return true;
        }
        break;
    default:
...
bool Automatons::Automaton_Reserved_i_kov(QChar c){
    ...
    case 3:
        ...
        if(c == 'v'){
            token = Token::TokenType::keyword;
            *datatype = Token::TokenSubtype::ikov;
            return true;
        }
        break;
    default:
...
bool Automatons::Automaton_Reserved_kalashn(QChar c){
    ...
    case 6:
        ...
        if(c == 'n'){
            token = Token::TokenType::keyword;
            *datatype = Token::TokenSubtype::kalashn;
            return true;
        }
        break;
    default:
...
bool Automatons::Automaton_Reserved_niet(QChar c){
    ...
    case 3:
        if(c == 't'){
            token = Token::TokenType::keyword;
            *datatype = Token::TokenSubtype::niet;
            return true;
        }
        break;
    default:
...
bool Automatons::Automaton_Reserved_strongon(QChar c){
    ...
    case 7:
        if(c == 'n'){
            token = Token::TokenType::keyword;
            *datatype = Token::TokenSubtype::strongon;
            return true;
        }
        break;
    case 8:
...
bool Automatons::Automaton_Reserved_yebat(QChar c){
    ...
    case 4:
        ...
        if(c == 't'){
            token = Token::TokenType::keyword;
            *datatype = Token::TokenSubtype::yebat;
            return true;
        }
        break;
    default:
...
bool Automatons::Automaton_Operator_0(QChar c){
    ...
    case '+':
        ...
        *datatype = Token::TokenSubtype::plus;
        operatorSymbol = &Automaton_Operator_Plus;
        return true;
        break;
    case '-':
        token = Token::TokenType::operation;
        *datatype = Token::TokenSubtype::minus;
        operatorSymbol = &Automaton_Operator_Minus;
        return true;
        break;
    case '*':
        token = Token::TokenType::operation;
        *datatype = Token::TokenSubtype::times;
        operatorSymbol = &Automaton_FAIL;
        return true;
        break;
    case '/':
        token = Token::TokenType::operation;
        *datatype = Token::TokenSubtype::division;
        operatorSymbol = &Automaton_FAIL;
        return true;
        break;
    case '=':
        token = Token::TokenType::operation;
        *datatype = Token::TokenSubtype::attribution;
    ...
    case '>':
        token = Token::TokenType::operation;
        *datatype = Token::TokenSubtype::bigger;
        operatorSymbol = &Automaton_Operator_bigger;
        return true;
        break;
    case '<':
        token = Token::TokenType::operation;
        *datatype = Token::TokenSubtype::smaller;
...
bool Automatons::Automaton_Operator_Plus(QChar c){
    ...
    if(c == '+'){
        token = Token::TokenType::operation;
        *datatype = Token::TokenSubtype::plusplus;
        return true;
    }
...
bool Automatons::Automaton_Operator_Minus(QChar c){
    ...
    if(c == '-'){
        token = Token::TokenType::operation;
        *datatype = Token::TokenSubtype::minusminus;
        return true;
    }
...
bool Automatons::Automaton_Operator_Equal(QChar c){
    ...
    if(c == '='){
        token = Token::TokenType::operation;
        *datatype = Token::TokenSubtype::equalequal;
        return true;
    }
...
bool Automatons::Automaton_Operator_Not(QChar c){
    ...
    if(c == '='){
        token = Token::TokenType::operation;
        *datatype = Token::TokenSubtype::notequal;
        return true;
    }
...
bool Automatons::Automaton_Operator_And(QChar c){
    ...
    if(c == '&'){
        token = Token::TokenType::operation;
        *datatype = Token::TokenSubtype::and_op;
        return true;
    }
...
bool Automatons::Automaton_Operator_Or(QChar c){
    ...
    if(c == '|'){
        token = Token::TokenType::operation;
        *datatype = Token::TokenSubtype::or_op;
        return true;
    }
...
bool Automatons::Automaton_Operator_bigger(QChar c){
    ...
    if(c == '='){
        token = Token::TokenType::operation;
        *datatype = Token::TokenSubtype::biggerequal;
        return true;
    }
...
bool Automatons::Automaton_Operator_smaller(QChar c){
    ...
    if(c == '='){
        token = Token::TokenType::operation;
        *datatype = Token::TokenSubtype::smallerequal;
        return true;
    }
